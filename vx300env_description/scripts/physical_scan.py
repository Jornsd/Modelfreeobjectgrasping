...
## Scanning positions
first_pos =     [0, 0, -0.5, 2.05, 0]            # 1 
second_pos =    [0, -1.65, 1, 1.5, 0]            # 2
third_pos =     [0, -0.9, 0.6, 1.6, 0]           # 3
fourth_pos =    [0, 0.4, -0.9, 2.1, 0]           # 4
fifth_pos =     [0.36, 0, -0.5, 2, 0]            # 5
sixth_pos =     [-0.41, 0, -0.5, 2, 0,]           # 6
