...
first_pos =     [0, -0.2, -0.2, 2, 0]#     1. scanning position
second_pos =    [0, -1.75, 1.55, 0.8, 0]#       2. scanning position
third_pos =     [0, -0.8, 0, 1.9, 0]#    3. scanning position
fourth_pos =    [0, 0.5, -0.8, 3.14, 0]#    4. scanning position
fifth_pos =     [0, -1.0, 0.3, -0.7, -1.5]#       5. scanning position
sixth_pos =     [0.5, -1.0, 0.3, -0.7, -1.9,]#     6. scanning position

pos_nr = 5 #Counter for loop. Nr of poses to visit (visit home in start and end)
