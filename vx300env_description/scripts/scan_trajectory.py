...
first_pos =     [0, 0, -0.5, 2, 0]#     1. scanning position
second_pos =    [0, -1.75, 1.55, 0.8, 0]#       2. scanning position
third_pos =     [0, -0.8, 0, 1.8, 0]#    3. scanning position
fourth_pos =    [0, 0.5, -0.8, 2.2, 0]#    4. scanning position
fifth_pos =     [0.5, 0, -0.5, 2, 0]#       5. scanning position
sixth_pos =     [-0.5, 0, -0.5, 2, 0,]#     6. scanning position
